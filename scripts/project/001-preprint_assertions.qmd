...
We define a lifecycle open research project as an Open OSF Preprint that meets the following criteria:
...
Note, these efficiencies are under-estimates, since we do not exclude preprints coming from providers that do not enable author assertions.
